# Harvey Workflow Builder: Prepare NSW Estate Planning Drafts

This guide maps `assemble-nsw-estate-documents` to one private Harvey Workflow
...
Create one Workflow agent named **Prepare NSW Estate Planning Drafts** for one
client in a practitioner-led New South Wales matter. Start a separate run for
each member of a couple. Do not combine it with the Victorian workflow.

The agent may prepare a will, enduring power of attorney and appointment of
enduring guardian.

## Harvey Vault placeholders

Create or select a senior-lawyer-maintained NSW Vault containing only the
current approved drafting materials. Complete these placeholders in the private
workflow build record:

```text
jurisdiction: NSW
Harvey Vault: <ADD EXACT NSW VAULT NAME>
Will precedent: <ADD EXACT NSW WILL PRECEDENT FILE NAME>
Enduring power of attorney precedent: <ADD EXACT NSW EPOA PRECEDENT FILE NAME>
Enduring guardian precedent: <ADD EXACT NSW ENDURING GUARDIAN PRECEDENT FILE NAME>
Instruction sheet: <ADD EXACT NSW INSTRUCTION SHEET FILE NAME>
Drafting playbook: <ADD EXACT NSW DRAFTING PLAYBOOK FILE NAME>
```
...
1. Run one complete NSW instruction set and confirm each draft uses the named
   Vault precedent and leaves the source unchanged.
...
5. Supply Victorian or two-client instructions and confirm the agent stops or
   routes without drafting.
